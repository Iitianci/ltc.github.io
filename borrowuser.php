...
<head>
	...
	<link rel="stylesheet" type="text/css" href="./css/borrowuser.css"/>
</head>
<body>
<div id="borrowuser_frame">
	<form  action="" method="post" name="form1">
		...
		<input class="button" type="submit" name="fh" value="返回"/>
...
if(isset($_POST["tj"])){
	...
	while($row=mysql_fetch_array($result)){
		if($xm==$row['user_name']){
			...
			echo "<td background-color:#00FFFF>"; echo "姓名"; echo "</td>";
			echo "<td background-color:#00FFFF>"; echo "未还的书籍"; echo "</td>";
			echo "<td background-color:#00FFFF>"; echo "借书时间"; echo "</td>";
			echo "</tr>";
	...
	echo "<td>"."<a href='borrowuser.php?curren=".(1)."'>首页</a>"."</td>";
	if($curren==1)
		echo "<td>"."<a href='borrowuser.php?curren=".($curren=1)."'>上一页</a>"."</td>";
	else
		echo "<td>"."<a href='borrowuser.php?curren=".($curren-1)."'>上一页</a>"."</td>";
	if($curren==ceil($sum/$size))
		echo "<td>"."<a href='borrowuser.php?curren=".(ceil($sum/$size))."'>下一页</a>"."</td>";
	else 
		echo "<td>"."<a href='borrowuser.php?curren=".($curren+1)."'>下一页</a>"."</td>";
	echo "<td>"."<a href='borrowuser.php?curren=".(ceil($sum/$size))."'>尾页</a>"."</td>";
	echo "</tr>";
}		
if(isset($_POST["fh"])){
